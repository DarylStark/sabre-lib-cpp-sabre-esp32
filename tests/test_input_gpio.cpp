...
TEST(InputGPIOMockTest, ResetCallsCorrectFunction)
{
    InputGPIO gpio(4);
    gpio.reset();
...
TEST(InputGPIOMockTest, ConstructorSetsDirection)
{
    InputGPIO gpio(5);
...
TEST(InputGPIOMockTest, EnablePullupCallsCorrectFunction)
{
    InputGPIO gpio(6);
    gpio.enable_pullup();
...
TEST(InputGPIOMockTest, EnablePulldownCallsCorrectFunction)
{
    InputGPIO gpio(7);
...
TEST(InputGPIOMockTest, DisablePullupCallsCorrectFunction)
{
    InputGPIO gpio(8);
    gpio.disable_pullup();
...
TEST(InputGPIOMockTest, DisablePulldownCallsCorrectFunction)
{
    InputGPIO gpio(9);
...
TEST(InputGPIOMockTest, AddISRCheckIfISRServiceIsInstalled)
{
    InputGPIO gpio(9);
...
TEST(InputGPIOMockTest, AddISRCheckIfISRServiceIsNotInstalledTwice)
{
    InputGPIO gpio_9(9);
...
TEST(InputGPIOMockTest, GetLevelReturnsCorrectValueFalse)
{
    InputGPIO gpio(11);
...
TEST(InputGPIOMockTest, GetLevelReturnsCorrectValueTrue)
{
    InputGPIO gpio(11);
...
TEST(InputGPIOMockTest, GetLevelReturnsCorrectValueFloating)
{
    InputGPIO gpio(11);
    bool level = gpio.get_level();
    ASSERT_EQ(level, false);
...
TEST(InputGPIOMockTest, SetAndRunISR)
{
    InputGPIO gpio(11);
...
TEST(InputGPIOMockTest, IsResettedInDestructor)
{
    {
        InputGPIO gpio(12);
    }
