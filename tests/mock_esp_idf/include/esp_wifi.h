...
#define ESP_ERR_WIFI_POST (ESP_ERR_WIFI_BASE + 18)
#define ESP_ERR_WIFI_INIT_STATE (ESP_ERR_WIFI_BASE + 19)
#define ESP_ERR_WIFI_STOP_STATE (ESP_ERR_WIFI_BASE + 20)
#define ESP_ERR_WIFI_NOT_ASSOC (ESP_ERR_WIFI_BASE + 21)
#define ESP_ERR_WIFI_TX_DISALLOW (ESP_ERR_WIFI_BASE + 22)
#define ESP_ERR_WIFI_TWT_FULL (ESP_ERR_WIFI_BASE + 23)
#define ESP_ERR_WIFI_TWT_SETUP_TIMEOUT (ESP_ERR_WIFI_BASE + 24)
#define ESP_ERR_WIFI_TWT_SETUP_TXFAIL (ESP_ERR_WIFI_BASE + 25)
#define ESP_ERR_WIFI_TWT_SETUP_REJECT (ESP_ERR_WIFI_BASE + 26)
#define ESP_ERR_WIFI_DISCARD (ESP_ERR_WIFI_BASE + 27)
#define ESP_ERR_WIFI_ROC_IN_PROGRESS (ESP_ERR_WIFI_BASE + 28)
...
#define WIFI_TX_HETB_QUEUE_NUM 0
extern const esp_event_base_t WIFI_EVENT;
extern const esp_event_base_t IP_EVENT;

#define WIFI_FEATURE_CAPS (WIFI_ENABLE_WPA3_SAE | WIFI_ENABLE_CACHE_TX_BUFFER | WIFI_FTM_INITIATOR | WIFI_FTM_RESPONDER | WIFI_ENABLE_GCMP | WIFI_ENABLE_GMAC | WIFI_ENABLE_11R | WIFI_ENABLE_ENTERPRISE | WIFI_ENABLE_BSS_MAX_IDLE)
